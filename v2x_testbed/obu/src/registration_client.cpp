 ...
 * Module: V2X Authentication Testbed — OBU Registration Client
 *
 * Purpose:
 *    Handles one-time registration with Desktop server. Connects via TCP,
 *    exchanges entity ID, and receives all provisioned cryptographic keys
 ...
 *    
 *    Registration Steps:
 *    1. Connect to Desktop TCP
 *    2. Send REGISTER_REQUEST with entity_id
 *    3. Receive key material: RID, AID, DAID, SK, PK_self, peer_pks
